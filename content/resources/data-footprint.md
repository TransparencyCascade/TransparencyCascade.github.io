...
Here is the surprise, and it is well-documented. In 2024, *Consumer Reports* ran a controlled study of paid data-removal services — the ones advertised on every podcast. Over four months, [the paid services removed only 35% of participants' personal records](https://innovation.consumerreports.org/new-report-data-defense-evaluating-people-search-site-removal-services/). Doing it yourself, by hand, removed **70%** — beating every paid service tested. The best paid performers (Optery and EasyOptOuts) cleared around two-thirds; the worst, names you would recognize, cleared four and six percent. The marketing spend and the removal rate are, if anything, inversely correlated.
...
- The open-source **Eraser** and similar projects send removal requests to 750+ brokers and show you which still need a manual nudge — better for the technically comfortable.
...
There is a bill to close this exactly — the **Fourth Amendment Is Not For Sale Act**. It [passed the House in 2024 with a bipartisan majority](https://www.aclu.org/press-releases/house-passes-fourth-amendment-is-not-for-sale-act) and then stalled in the Senate, where it still sits. It bans the government from buying the data it would otherwise need a warrant to get. The loophole is a *choice*, and choices can be pressured.
